...
public class LanguageManager {
    ...
    public static void initGTMaterials() {
        ...
        addGTMaterialLocalization(MaterialCherryBlossom.Stygian, "冥河");
        addGTMaterialLocalization(MaterialCherryBlossom.Demise, "终焉");
        addGTMaterialLocalization(MaterialCherryBlossom.CherryBlossomDreamMatter,"桜❀夢");
//        addStringLocalization("senseofcherryblossom.blockcasings.multi.32767.name", "任意本方块的子方块");
//        addStringLocalization("senseofcherryblossom.blockmetal01.0.name", "%material块");
//        addStringLocalization("senseofcherryblossom.blockmetal01.1.name", "%material块");
//        addStringLocalization("senseofcherryblossom.blockmetal01.2.name", "%material块");
//        addStringLocalization("senseofcherryblossom.blockmetal01.3.name", "%material块");
//        addStringLocalization("senseofcherryblossom.blockmetal01.32767.name", "任意本方块的子方块");
    }
