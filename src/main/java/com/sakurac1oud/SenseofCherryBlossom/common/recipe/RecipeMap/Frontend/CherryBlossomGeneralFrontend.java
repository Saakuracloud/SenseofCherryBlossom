package com.sakurac1oud.SenseofCherryBlossom.common.recipe.RecipeMap.Frontend;
...
public class CherryBlossomGeneralFrontend extends RecipeMapFrontend {
    private static final int xDirMaxCount = 4;
    private static final int yOrigin = 8;
    private final int itemRowCount;

    public CherryBlossomGeneralFrontend(BasicUIPropertiesBuilder uiPropertiesBuilder,
