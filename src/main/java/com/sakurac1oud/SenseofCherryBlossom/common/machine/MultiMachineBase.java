...
import com.sakurac1oud.SenseofCherryBlossom.Config;
import com.sakurac1oud.SenseofCherryBlossom.utils.TextEnums;
...
public abstract class MultiMachineBase<T extends MultiMachineBase<T>>
    ...
    protected gregtech.api.logic.ProcessingLogic createProcessingLogic() {
    ...
    public int getTotalPowerTier() {
        return Utils.getMachineTotalPowerTier(this);
    }
